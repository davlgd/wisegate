...
#[command(long_about = "A high-performance, secure reverse proxy with built-in rate limiting and IP filtering.\n\nExample usage:\n  wisegate --listen 8080 --forward 9000\n  wisegate -l 8080 -f 9000 --verbose")]
...
pub struct Args {
    ...
    #[arg(long, short = 'l', help = "Listen port for incoming connections", value_name = "PORT")]
    pub listen: u16,

    /// Port to forward requests to
    #[arg(long, short = 'f', help = "Destination port for forwarded requests", value_name = "PORT")]
    pub forward: u16,
